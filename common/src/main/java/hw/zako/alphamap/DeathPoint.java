...
// Место последней смерти сервер и так шлёт клиенту ванильным пакетом (на нём же работает компас
// возрождения), поэтому своего протокола под него не нужно.
@UtilityClass
public class DeathPoint {
    ...
    // Полый квадрат с точкой в центре: не путается ни с метками, ни с точками сущностей.
